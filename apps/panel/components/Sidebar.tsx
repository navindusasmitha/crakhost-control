...
import {LayoutDashboard,Server,Database,HardDrive,CreditCard,Settings,Shield,Boxes,Headphones,Code2,ActivitySquare,LockKeyhole,Network,Rocket,ShoppingCart,Receipt,Mail,Mailbox,Store} from 'lucide-react';
...
const adminItems:Item[]=[
 ...
 {href:'/admin/commerce',label:'Plans & Customers',icon:Store,adminOnly:true},
...
export default function Sidebar({staff,admin}:{staff:boolean;admin:boolean}){
 ...
 return <aside className="sidebar">
   <Link href="/dashboard" className="brand"><span>CRAK<span style={{color:'#a78bfa'}}>HOST</span></span></Link>
